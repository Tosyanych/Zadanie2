...
$.extend( $.validator, {
	...
	messages: {
		...
		Fio: "Пожалуйста, вводите только буквы.",
		...
		init: function() {
			...
			$( this.currentForm )
				.on( "focusin.validate focusout.validate keyup.validate",
					...
					"[type='tel'], [type='url'], [type='email'], [type='Fio'], [type='datetime'], [type='date'], [type='month'], " +
	...
	methods: {
		...
		Fio: function (value, element) {
			return this.optional(element) || /^[a-zа-яё\s]+$/.test(value);
		},
